jwplayer().registerPlugin('signosjwplayer', '6.0', function(player, config, slowmo){
	function setup(evt){
		...
		if (player.getRenderingMode() == "html5"){
			...
			var usedPosition = "bl"; // tl=top-left; bl=bottom-left; br=bottom-right; tr=top-right;
			var usedSize = "large"; // large=100%; medium="50%"; small="25%"; complete="same as video";
			var usedLineHeightDiv = "normal";
			var usedLineHeightP = "normal";
			var usedLineHeightSpan = "normal";
			
			var signlenguagevideo = "false";
			var kindcaptions = "";
			var labelcaptions = "";
			...
			player.onCaptionsChange(
					function captionsChange(event) {
						//alert("Evento: " + currentCaptionTrackFileSet);
						//alert("Evento: " + player.getCurrentCaptions());
						extraeCurrentCaptions();
						
						if(player.getCurrentCaptions()>0 && labelCaptions=="LS")
						{
							signlenguagevideo = true;
							//extraeCurrentCaptions();
							//alert("Current captions: " + currentCaptionTrackFileSet);
							borraMyElementCaption();
							var elementCaptions = document.getElementById('myElement_caption');
							var newDiv = document.createElement('div');
							newDiv.id = 'divSubtitulo';
							elementCaptions.appendChild(newDiv);
							var newVideo = document.createElement('video');
							newVideo.id = "videoLS";
							newDiv.appendChild(newVideo);
							if(currentCaptionTrackFileSet!=undefined)
							{
								//alert("Captions set: " + currentCaptionTrackFileSet);
								newVideo.setAttribute("src", currentCaptionTrackFileSet); 
							}
							//newVideo.setAttribute("src", currentCaptionTrackFileSet);
							newVideo.currentTime = player.getPosition();
							newVideo.play();
							player.setCaptionsChange("0");
						}
						//alert("signlenguagevideo After: " + signlenguagevideo);
						
						//alert("getCaptionsChangeAfter: " + player.getCurrentCaptions() );
						...
						var newVideo = document.createElement('video');
						if(currentCaptionTrackFileSet!=undefined)
							{ alert("Undefined captions"); newVideo.setAttribute("src", currentCaptionTrackFileSet); }
						//newVideo.setAttribute("src", "http://www.gatv.ssr.upm.es/~jlv/hbb4all/videos/Secuencia_LSP_1M.mp4");
						newVideo.id = "videoLS";
						newDiv.appendChild(newVideo);
						newVideo.currentTime = player.getPosition();
						newVideo.play();
						//newDiv.style.width = "200px";
						// Continuar por aquí Juanpe (16/02/2016)*/
					}
			);
			...
			cambiarPosicion = function(){
				//alert("Cambia Posicion");
				var videoTag = document.getElementById("videoLS");
				setGeneralSizes(player.getWidth(), player.getHeight());
				videoTag.style.position = "absolute";
				selectPosition(videoTag, usedPosition, usedWidth, usedHeight);
			}
			
			selectPosition = function(element, position, width, height){
			...
			cambiarTamano = function(){
				//alert("Cambia Tamaño");
				var videoTag = document.getElementById("videoLS");
				setGeneralSizes(player.getWidth(), player.getHeight());
				//alert(usedWidth + ":" + usedHeight);
				selectTamano(videoTag, usedSize, usedWidth, usedHeight);
			}
			
			selectTamano = function(element, size, width, height){
				if(size=="large"){
			...
			extraeCurrentCaptions = function() {
				...
				currentCaptionTrackFileSet = player.getCurrentCaptions();
				...
				if(currentCaptionsSet != 0)
				{
						...
						labelCaptions = matrixCaptionsLabels[currentCaptionsSet-1];
						kindCaptions = matrixCaptionsKinds[currentCaptionsSet-1]; 
				...
				{
					currentCaptionTrackFileSet = "0"; 
					currentCaptionKindSet = "";
					currentCaptionLabelSet = "";
				}
			}
			...
			player.onSeek(
					function(event) {
						...
						var videoTag = document.getElementById("videoLS");
						videoTag.currentTime = player.getPosition();
					}
				);
	...
	player.addButton("data:image/jpeg;base64,","Position", 
	        function() { 
				cambiarPosicion(); 
				player.onReady(setup);
				//setup(this);
	        ...
	        "position");
	player.addButton("data:image/jpeg;base64,", "Size", 
	        function() { 
				cambiarTamano(); 
				player.onReady(setup);
				//setup(this);
